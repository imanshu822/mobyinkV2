...
import Insights1 from "../../../public/assests/Insights1.webp";
import Insights2 from "../../../public/assests/Insights2.webp";
import Insights3 from "../../../public/assests/Insights3.webp";
...
const CaseStudies = () => {
  ...
  const selectedBlog = blogData.find(
    (blog) => blog.blogSlug === pathname.split("/").pop()
  );
  return (
