...
import lock from "../../../../public/assests/pppc1.svg";
import video from "../../../../public/assests/pppc2.svg";
import bulb from "../../../../public/assests/pppc3.svg";
import hand from "../../../../public/assests/pppc4.svg";
  ...
  const stackComponents = stackData.map((item, index) => (
    ...
    >
      <Stack
        ...
        height={"100%"}
      >
        <Image width={40} height={40} src={item.image} component="img" />{" "}
        <Typography
          textAlign={"center"}
          fontSize={{
            xs: "15px",
