...
import AppStore from "../../../../public/assests/av1.webp";
import nearByPlaceImg from "../../../../public/assests/av2.webp";
import mobileGraphImg from "../../../../public/assests/av3.webp";
import mobileAppArtImg from "../../../../public/assests/av4.webp";
...
const AppServices = () => {
  ...
  return (
    <Stack>
      <Stack alignItems={"Center"} gap={1} p={"140px 0 80px 0 "}>
        <Stack>
          <Typography
            fontSize={{
              xs: "35px",
