...
import lo from "../../public/assests/LogoBlue.svg";
import logoDarkImg from "../../public/assests/logo_dark.svg";
...
const item = {
  ...
  howto: "/how-to-improve-your-site-seo-rankings",
  howtosecure: "/how-to-secure-and-optimize-your-apps-online-visibility",
  aboutUs: "/about",
...
const Nav = () => {
  ...
  const handleEmailClick = () => {
    const subject = encodeURIComponent("Company Inquiry");
    const body = encodeURIComponent(
      "Hello, I am interested in your services. Please contact me at this email address."
    );
        ...
        >
          <Stack width={{ xxl: "10%", xl: "13%", md: "20%", sm: "25%" }}>
            <Link href={`${item.link1}`}>
              <Image src={lo} alt="" width={200} height={50} />
            </Link>
          </Stack>
          <Stack
            direction="row"
          ...
          >
            ...
            >
              ...
              >
                <Box>
                  <Link href={`${item.link1}`} className="navlink-link">
                    <Box
                      display={"flex"}
                      ...
                      <Stack width={"25%"} bgcolor={"white"}>
                        ...
                        >
                          ...
                          <Stack>
                            ...
                            >
                              <Typography>
                                How to Secure and Optimize Your Apps Online
                                Visibility
                              </Typography>
                            </Link>
                            <Box
              ...
              >
                <Box>
                  <Link href={`${item.aboutUs}`} className="navlink-link">
                    <Box
                      display={"flex"}
                      justifyContent="center"
                      alignItems={"center"}
              ...
              <div style={{ display: "flex", alignItems: "center" }}>
                <Box>
                  <Link href={`${item.industries}`} className="navlink-link">
                    <Box
                      display={"flex"}
                      justifyContent="center"
                      alignItems={"center"}
              ...
              <div style={{ display: "flex", alignItems: "center" }}>
                ...
                >
                  <Link href={`${item.caseStudies}`} className="navlink-link">
                    <Box
                      display={"flex"}
                      justifyContent="center"
                      alignItems={"center"}
      ...
      {showNavbar && (
        ...
        >
          ...
          >
            <Stack width={{ xxl: "10%", xl: "13%", md: "20%", sm: "25%" }}>
              <Link href={`${item.link1}`}>
                <Image src={logoDarkImg} alt="" width={200} height={50} />
              </Link>
            </Stack>
            <Stack
              direction="row"
          ...
          <Stack width={"100%"} bgcolor={"#0D6EFD"}>
            ...
            >
              <Stack width={{ xs: "45%", md: "30%" }}>
                ...
                >
                  <Image src={logoDarkImg} alt="" width={170} height={50} />
                </Link>
              </Stack>
              <Stack
                onClick={handleClick}
